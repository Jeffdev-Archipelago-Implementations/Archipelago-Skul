...
def create_regular_locations(world: SkulWorld) -> None:
    ...
    bottom_left_chest = SkulLocation(
    ...
    bottom_right_room.add_locations(bottom_right_room_locations, SkulLocation)

    top_left_room_locations = get_location_names_with_ids(["Top Left Room Chest"])
    top_left_room.add_locations(top_left_room_locations, SkulLocation)

    right_room_locations = get_location_names_with_ids(["Right Room Enemy Drop"])
    right_room.add_locations(right_room_locations, SkulLocation)
    ...
    if world.options.hammer:
        ...
        top_middle_room.add_locations(top_middle_room_locations, SkulLocation)
    else:
        overworld.add_locations(top_middle_room_locations, SkulLocation)
    ...
    if world.options.extra_starting_chest:
        ...
        overworld.add_locations(bottom_left_extra_chest, SkulLocation)
...
def create_events(world: SkulWorld) -> None:
    ...
    button_in_top_left_room = SkulLocation(world.player, "Top Left Room Button", None, top_left_room)
    ...
    button_item = items.SkulItem("Top Left Room Button Pressed", ItemClassification.progression, None, world.player)
